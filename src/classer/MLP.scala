...
object MLP {
  ...
  def PreProcess3(path:String):DataFrame={
    ...
    val data = sparkSession.read.format("csv")
      ...
      .load(path)
      .toDF("f1","f2","f3","f4","f5","f6","f7","f8","label")
  ...
  def PreProccess1(path: String): DataFrame = {
    ...
    val sparkSession = SparkSession.builder().master("spark://192.168.0.108:7077").appName("MLP").getOrCreate()
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data2 = PreProcess2("/Users/denghanbo/Desktop/inputdata.txt")
    ...
    //指定层数，29个输入层，1个输出层
    val layers = Array[Int](4, 200,200,2)
   ...
   val data3 = trainer.fit(trainingData)
     .transform(testData)
    ...
    val accuracy = evaluator.evaluate(data3)
